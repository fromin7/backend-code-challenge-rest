import { PokemonJsonRecord } from './seeder.types';
const pokemons: PokemonJsonRecord[] = [
  {
    id: '001',
    name: 'Bulbasaur',
  ...
  },
  {
    ...
    types: ['Water', 'Poison'],
    resistant: ['Fire', 'Water', 'Ice', 'Fighting', 'Poison', 'Bug', 'Steel', 'Fairy'],
  ...
  },
  {
    ...
    resistant: ['Normal', 'Electric', 'Grass', 'Ice', 'Poison', 'Flying', 'Psychic', 'Bug', 'Rock', 'Dragon', 'Steel', 'Fairy'],
